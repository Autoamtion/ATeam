...
{
    public class DataForCertification : Page
    {
        public DataForCertification(IWebDriver webdriver) : base(webdriver)
        {
        }
        ...
        [FindsBy(How = How.ClassName, Using = "js-product-delete")]
